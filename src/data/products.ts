		...
		subCategories: [
			...
			},
			{
				...
				products: [
					...
					{
						slug: 'penetrating-rust-proof-lubricant',
						name: '渗透松动润滑剂',
						spec: '330ml / 24 支/件',
						desc: '创新型多功能喷剂，环保配方，专业喷针设计，方便施工；集防锈、除锈、润滑、排湿、清洁于一体。',
						image: '/images/batch-products/lionax-penetrating-lubricant.png',
						imageScale: 'detailing-bottle',
						alt: 'lionax 渗透松动润滑剂',
						features: [
							'专业喷针设计，方便施工',
							...
							'防锈、除锈、润滑、排湿、清洁一支搞定',
							'环保配方，减少浪费和使用负担',
							'适用于门锁、铰链、自行车链条等日常维护场景',
						],
						parameters: [
							['产品类型', '渗透松动润滑剂'],
							['英文名称', 'Agent for Penetrating Rust-Proofing and Lubricating'],
							['商品编号', '3737'],
							['容量', '330ml'],
							['包装规格', '24 支/件'],
							['应用场景', '门锁 / 车门铰链 / 滑轨 / 自行车链条 / 金属零部件维护'],
							['主要功效', '防锈 / 除锈 / 润滑 / 排湿 / 清洁'],
						],
						detailSections: [
							{
								title: '深度润滑，开合无噪音',
								desc: '渗入零部件缝隙，润滑滑轨与铰链结构，减少异响，让开合更顺滑。',
								image: '/images/batch-products/lionax-penetrating-lubricant-drawer.png',
								alt: '渗透松动润滑剂滑轨润滑场景',
							},
							{
								title: '部件润滑，一喷见效',
								desc: '适合门锁、车门铰链等金属部件维护，无酸碱腐蚀性，兼顾清洁油污与润滑保护。',
								image: '/images/batch-products/lionax-penetrating-lubricant-parts.png',
								alt: '渗透松动润滑剂门锁和车门铰链润滑展示',
							},
							{
								title: '清洁油污，焕新状态',
								desc: '可用于自行车链条等机械结构，清洁油污的同时形成润滑养护，一瓶多用。',
								image: '/images/batch-products/lionax-penetrating-lubricant-bike-chain.png',
								alt: '渗透松动润滑剂自行车链条清洁前后对比',
							},
						],
					},
					{
					...
					{
											slug: 'brake-parts-cleaner',
											name: '刹车及零部件清洁剂',
											spec: 'Brake & Parts Cleaner / 500ml',
											desc: '用于清洁制动系统油渍、污物、粉尘及制动粉尘，不含盐酸、氟氯碳化物、芳香碳化物等有害物质，并可防止石棉粉尘产生。',
											image: '/images/batch-products/lionax-brake-parts-cleaner.png',
											imageScale: 'detailing-bottle',
											alt: 'lionax 刹车及零部件清洁剂',
											features: [
												'清洁制动系统油渍、污物和制动粉尘',
												'不含盐酸、氟氯碳化物和芳香碳化物等有害物质',
												'帮助防止石棉粉尘产生',
												'适合制动部件彻底清洁',
												'可配合摩擦片钢刷刷洗清除污物',
												'适用于刹车系统快保施工',
											...
											parameters: [
												['产品类型', '刹车及零部件清洁剂'],
												['英文名称', 'Brake & Parts Cleaner'],
												['商品编号', '2108'],
												['容量', '500ml'],
												['包装规格', '24 支/件'],
												['应用场景', '制动系统 / 刹车零部件 / 快保清洁施工'],
												['主要功效', '清洁油渍 / 清洁粉尘 / 清洁制动粉尘 / 环保清洁'],
												['使用方法', '使用清洁剂对制动部件彻底清洁，摩擦片可用钢刷刷洗清除油污、粉尘等污物'],
											],
											detailSections: [
												{
													title: '制动器专业保养套装',
													desc: '可与 DOT4 制动液及制动系统保护油膏配合，用于门店制动系统清洁、保养和维护施工。',
													image: '/images/batch-products/lionax-brake-care-set.png',
													alt: 'lionax 制动器专业保养套装',
												},
												{
													title: '刹车分泵润滑油膏',
													desc: '不含金属皂成分，耐弱酸碱、无腐蚀，能够润滑和保养分泵衬套，防水并具备高承载能力。',
													image: '/images/batch-products/lionax-brake-pump-grease.png',
													alt: '刹车分泵润滑油膏说明',
												},
												{
													title: '制动系统保护油膏',
													desc: '用于轮毂与钢圈之间以及制动系统咬合点，帮助抵抗防滑盐和水溅，防止轮毂与胎铃之间锈蚀粘连。',
													image: '/images/batch-products/lionax-brake-system-protective-grease.png',
													alt: '制动系统保护油膏说明',
												},
												{
													title: '刹车耐高温消音油膏',
													desc: '用于刹车片背面和卡槽部位，具备高承载、抗磨、防水及酸碱能力，帮助减少刹车噪音。',
													image: '/images/batch-products/lionax-brake-high-temp-quiet-grease.png',
													alt: '刹车耐高温消音油膏说明',
												},
											],
										},
